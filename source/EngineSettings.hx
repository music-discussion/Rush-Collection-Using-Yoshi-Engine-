...
@:keep class SuperCoolSettings {
	...
	@:keep public static var hideOriginalGame:Bool = true;
	...
	@:keep public static var selectedMod:String = "Rush Collection"; // for ui stuff
	...
	@:keep public static var lastInstalledMods:Array<String> = ["Friday Night Funkin'", "YoshiEngine", "Rush Collection"];
